...
/*
 auxexcepcion-simular-springnut-test.js
 Creado 201409160124
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "auxexcepcion-simular-springnut-test";
        var ModulePackages = "springnut-test/aux-test/excepciones-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_EXCEPCION_SIMULAR = "auxcriterio_cambiar_springnut";

            theToInit.PARM_EXCEPCION_SIMULAR_URLPATH = theToInit.PARMSPREFIX_EXCEPCION_SIMULAR + ".URLpath";



            theToInit.PARMS_EXCEPCION_SIMULAR = [
                theToInit.PARM_EXCEPCION_SIMULAR_URLPATH,
                theToInit.PARM_SESSIONTEST
            ];



            theToInit.URLPATH_DEFAULT = "/aux/simularExcepcionJSON";
        ...
        var aAuxExcepcionSimulaSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "AuxExcepcionSimulaSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_AuxExcepcionSimulaSpringnut( theTitle, theConfiguration, theIdentifier, theRecorder, theSession);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_AuxExcepcionSimulaSpringnut = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_AuxExcepcionSimulaSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_AuxExcepcionSimulaSpringnut){}/* CQT */
            aPrototype._pInit_AuxExcepcionSimulaSpringnut = _pInit_AuxExcepcionSimulaSpringnut;
            ...
            var _pRelease = function( theReleaseParms, theReleaseDone) {
                ...
                this._pRelease_AuxExcepcionSimulaSpringnut( theReleaseParms, theReleaseDone);
            };
            if( _pRelease){}/* CQT */
            ...
            var _pRelease_AuxExcepcionSimulaSpringnut = function( theReleaseParms, theReleaseDone) {

                /* Delegate on super prototype release */
                this._v_SuperPrototype._pRelease_RunSubs.apply( this, [ theReleaseParms, theReleaseDone]);

            };
            if( _pRelease_AuxExcepcionSimulaSpringnut){}/* CQT */
            aPrototype._pRelease_AuxExcepcionSimulaSpringnut = _pRelease_AuxExcepcionSimulaSpringnut;
            ...
            var pCleanUpTest = function( theWhatToClean, theReleaseParms, theReleaseDone) {
                ...
                this.pCleanUpTest_AuxExcepcionSimulaSpringnut( theWhatToClean, theReleaseParms, theReleaseDone);
            };
            if( pCleanUpTest){}/* CQT */
            ...
            var pCleanUpTest_AuxExcepcionSimulaSpringnut = function( theWhatToClean, theReleaseParms, theReleaseDone) {
            ...
            if( pCleanUpTest_AuxExcepcionSimulaSpringnut){}/* CQT */
            aPrototype.pCleanUpTest_AuxExcepcionSimulaSpringnut = pCleanUpTest_AuxExcepcionSimulaSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EXCEPCION_SIMULAR_URLPATH
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EXCEPCION_SIMULAR_URLPATH];
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, theResponse.body, "theResponse.body", null);
            ...
            var pS_AuxExcepcionSimular = function( theCallback) {

                var aMethodName = "pS_AuxExcepcionSimular";
            ...
            if( pS_AuxExcepcionSimular){}/* CQT */
            aPrototype.pS_AuxExcepcionSimular = pS_AuxExcepcionSimular;
            ...
            var pF_AuxExcepcionSimulaSpringnut = function( theCallback) {
                var aMethodName = "pF_AuxExcepcionSimulaSpringnut";
            ...
            if( pF_AuxExcepcionSimulaSpringnut){}/* CQT */
            aPrototype.pF_AuxExcepcionSimulaSpringnut = pF_AuxExcepcionSimulaSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_AuxExcepcionSimulaSpringnut.bind( this);
            };
            ...
            var pSS_AuxExcepcionSimulaSpringnut = function( theCallback) {
                var aMethodName = "pSS_AuxExcepcionSimulaSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_AuxExcepcionSimular.bind( this),
            ...
            if( pSS_AuxExcepcionSimulaSpringnut){}/* CQT */
            aPrototype.pSS_AuxExcepcionSimulaSpringnut = pSS_AuxExcepcionSimulaSpringnut;
        ...
        var AuxExcepcionSimulaSpringnutTest_Constructor = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        AuxExcepcionSimulaSpringnutTest_Constructor.prototype = aAuxExcepcionSimulaSpringnutTest_Prototype;





        var AuxExcepcionSimulaSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aAuxExcepcionSimulaSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        AuxExcepcionSimulaSpringnutTest_SuperPrototypeConstructor.prototype = aAuxExcepcionSimulaSpringnutTest_Prototype;



        var aModule = {
            "AuxExcepcionSimulaSpringnutTest_Prototype": aAuxExcepcionSimulaSpringnutTest_Prototype,
            "AuxExcepcionSimulaSpringnutTest_Constructor": AuxExcepcionSimulaSpringnutTest_Constructor,
            "AuxExcepcionSimulaSpringnutTest_SuperPrototypeConstructor": AuxExcepcionSimulaSpringnutTest_SuperPrototypeConstructor
        };
