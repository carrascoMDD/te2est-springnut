...
/*
 auxcriterio-idreciclado-springnut-test.js
 Creado 201409121109
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "auxcriterio-idreciclado-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_CRITERIO_IDRECICLADO = "auxcriterio_idreciclado_springnut";

            theToInit.PARM_CRITERIO_IDRECICLADO_URLPATH = theToInit.PARMSPREFIX_CRITERIO_IDRECICLADO + ".URLpath";


            theToInit.PARMS_CRITERIO_IDRECICLADO = [
                theToInit.PARM_CRITERIO_IDRECICLADO_URLPATH,
                theToInit.PARM_SESSIONTEST
            ];



            theToInit.URLPATH_DEFAULT = "/aux/criterios/auxCriterioIdRecicladoJSON";
        ...
        var aAuxCriterioIdRecicladoSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "AuxCriterioIdRecicladoSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_AuxCriterioIdRecicladoSpringnut( theTitle, theConfiguration, theIdentifier, theRecorder, theSession);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_AuxCriterioIdRecicladoSpringnut = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_AuxCriterioIdRecicladoSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_AuxCriterioIdRecicladoSpringnut){}/* CQT */
            aPrototype._pInit_AuxCriterioIdRecicladoSpringnut = _pInit_AuxCriterioIdRecicladoSpringnut;
            ...
            var _pRelease = function( theReleaseParms, theReleaseDone) {
                ...
                this._pRelease_AuxCriterioIdRecicladoSpringnut( theReleaseParms, theReleaseDone);
            };
            if( _pRelease){}/* CQT */
            ...
            var _pRelease_AuxCriterioIdRecicladoSpringnut = function( theReleaseParms, theReleaseDone) {

                /* Delegate on super prototype release */
                this._v_SuperPrototype._pRelease_RunSubs.apply( this, [ theReleaseParms, theReleaseDone]);

            };
            if( _pRelease_AuxCriterioIdRecicladoSpringnut){}/* CQT */
            aPrototype._pRelease_AuxCriterioIdRecicladoSpringnut = _pRelease_AuxCriterioIdRecicladoSpringnut;
            ...
            var pCleanUpTest = function( theWhatToClean, theReleaseParms, theReleaseDone) {
                ...
                this.pCleanUpTest_AuxCriterioIdRecicladoSpringnut( theWhatToClean, theReleaseParms, theReleaseDone);
            };
            if( pCleanUpTest){}/* CQT */
            ...
            var pCleanUpTest_AuxCriterioIdRecicladoSpringnut = function( theWhatToClean, theReleaseParms, theReleaseDone) {
            ...
            if( pCleanUpTest_AuxCriterioIdRecicladoSpringnut){}/* CQT */
            aPrototype.pCleanUpTest_AuxCriterioIdRecicladoSpringnut = pCleanUpTest_AuxCriterioIdRecicladoSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_CRITERIO_IDRECICLADO_URLPATH
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_CRITERIO_IDRECICLADO_URLPATH];
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    if( !( typeof theResponse.body == "number")) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!( typeof theResponse.body == 'number')", null));
                        return false;
                    }
                    ...
                    aThis._v_IdCriterio =  theResponse.body;


                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, theResponse.body, " (Number) theResponse.body", null);
            ...
            var pS_AuxCriterioIdReciclado = function( theCallback) {

                var aMethodName = "pS_AuxCriterioIdReciclado";
            ...
            if( pS_AuxCriterioIdReciclado){}/* CQT */
            aPrototype.pS_AuxCriterioIdReciclado = pS_AuxCriterioIdReciclado;
            ...
            var pF_AuxCriterioIdRecicladoSpringnut = function( theCallback) {
                var aMethodName = "pF_AuxCriterioIdRecicladoSpringnut";
            ...
            if( pF_AuxCriterioIdRecicladoSpringnut){}/* CQT */
            aPrototype.pF_AuxCriterioIdRecicladoSpringnut = pF_AuxCriterioIdRecicladoSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_AuxCriterioIdRecicladoSpringnut.bind( this);
            };
            ...
            var pSS_AuxCriterioIdRecicladoSpringnut = function( theCallback) {
                var aMethodName = "pSS_AuxCriterioIdRecicladoSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_AuxCriterioIdReciclado.bind( this),
            ...
            if( pSS_AuxCriterioIdRecicladoSpringnut){}/* CQT */
            aPrototype.pSS_AuxCriterioIdRecicladoSpringnut = pSS_AuxCriterioIdRecicladoSpringnut;
        ...
        var AuxCriterioIdRecicladoSpringnutTest_Constructor = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        AuxCriterioIdRecicladoSpringnutTest_Constructor.prototype = aAuxCriterioIdRecicladoSpringnutTest_Prototype;





        var AuxCriterioIdRecicladoSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aAuxCriterioIdRecicladoSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        AuxCriterioIdRecicladoSpringnutTest_SuperPrototypeConstructor.prototype = aAuxCriterioIdRecicladoSpringnutTest_Prototype;



        var aModule = {
            "AuxCriterioIdRecicladoSpringnutTest_Prototype": aAuxCriterioIdRecicladoSpringnutTest_Prototype,
            "AuxCriterioIdRecicladoSpringnutTest_Constructor": AuxCriterioIdRecicladoSpringnutTest_Constructor,
            "AuxCriterioIdRecicladoSpringnutTest_SuperPrototypeConstructor": AuxCriterioIdRecicladoSpringnutTest_SuperPrototypeConstructor
        };
