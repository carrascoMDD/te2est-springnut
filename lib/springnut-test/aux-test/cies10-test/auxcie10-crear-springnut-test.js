...
/*
 auxcie10-crear-springnut-test.js
 Creado 201409121109
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "auxcie10-crear-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_CIE10_CREAR = "auxcie10_crear_springnut";

            theToInit.PARM_CIE10_CREAR_URLPATH = theToInit.PARMSPREFIX_CIE10_CREAR + ".URLpath";

            theToInit.PARM_CIE10_CREAR_IDCIE10 = theToInit.PARMSPREFIX_CIE10_CREAR + ".idcie10";
            theToInit.PARM_CIE10_CREAR_TITULO  = theToInit.PARMSPREFIX_CIE10_CREAR + ".titulo";
            theToInit.PARM_CIE10_CREAR_IDLESI  = theToInit.PARMSPREFIX_CIE10_CREAR + ".idlesi";
            theToInit.PARM_CIE10_CREAR_IDMORBI = theToInit.PARMSPREFIX_CIE10_CREAR + ".idmorbi";


            theToInit.PARMS_CIE10_CREAR = [
                theToInit.PARM_CIE10_CREAR_URLPATH,
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_IDCIE10,
                theToInit.PARM_CIE10_CREAR_IDCIE10,
                theToInit.PARM_CIE10_CREAR_TITULO,
                theToInit.PARM_CIE10_CREAR_IDLESI,
                theToInit.PARM_CIE10_CREAR_IDMORBI
            ];



            theToInit.URLPATH_DEFAULT = "/aux/cies10/auxCie10CrearJSON";
        ...
        var aAuxCie10CrearSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "AuxCie10CrearSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_AuxCie10CrearSpringnut( theTitle, theConfiguration, theIdentifier, theRecorder, theSession);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_AuxCie10CrearSpringnut = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_AuxCie10CrearSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_AuxCie10CrearSpringnut){}/* CQT */
            aPrototype._pInit_AuxCie10CrearSpringnut = _pInit_AuxCie10CrearSpringnut;
            ...
            var _pRelease = function( theReleaseParms, theReleaseDone) {
                ...
                this._pRelease_AuxCie10CrearSpringnut( theReleaseParms, theReleaseDone);
            };
            if( _pRelease){}/* CQT */
            ...
            var _pRelease_AuxCie10CrearSpringnut = function( theReleaseParms, theReleaseDone) {

                /* Delegate on super prototype release */
                this._v_SuperPrototype._pRelease_RunSubs.apply( this, [ theReleaseParms, theReleaseDone]);

            };
            if( _pRelease_AuxCie10CrearSpringnut){}/* CQT */
            aPrototype._pRelease_AuxCie10CrearSpringnut = _pRelease_AuxCie10CrearSpringnut;
            ...
            var pCleanUpTest = function( theWhatToClean, theReleaseParms, theReleaseDone) {
                ...
                this.pCleanUpTest_AuxCie10CrearSpringnut( theWhatToClean, theReleaseParms, theReleaseDone);
            };
            if( pCleanUpTest){}/* CQT */
            ...
            var pCleanUpTest_AuxCie10CrearSpringnut = function( theWhatToClean, theReleaseParms, theReleaseDone) {
            ...
            if( pCleanUpTest_AuxCie10CrearSpringnut){}/* CQT */
            aPrototype.pCleanUpTest_AuxCie10CrearSpringnut = pCleanUpTest_AuxCie10CrearSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_CIE10_CREAR_URLPATH,
                        aThis.PARM_CIE10_CREAR_IDCIE10,
                        aThis.PARM_IDCIE10,
                        aThis.PARM_CIE10_CREAR_TITULO,
                        aThis.PARM_CIE10_CREAR_IDLESI,
                        aThis.PARM_CIE10_CREAR_IDMORBI
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_CIE10_CREAR_URLPATH];
                    ...
                    if( !aThis._v_IdCie10) {
                        var aIdCie10Resolution = aParmResolutionsDict[ this.PARM_CIE10_CREAR_IDCIE10];
                        ...
                        if( !aThis._v_IdCie10) {
                            theOtherCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_FAIL, null, "!aThis._v_IdCie10 && !aThis._v_Configuration.fParmResolutions( '" + this.PARM_CIE10_CREAR_IDCIE10 + "')", null));
                            return  false;
                        }
                    }
                    ...
                    if( !aThis._v_Titulo) {
                        var aTituloResolution = aParmResolutionsDict[ this.PARM_CIE10_CREAR_TITULO];
                        if( !aTituloResolution || !aTituloResolution._v_Success || !aTituloResolution._v_ParmValue) {
                            theOtherCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_FAIL, null, "!aThis._v_Titulo && !aThis._v_Configuration.fParmResolutions( '" + this.PARM_CIE10_CREAR_CRID + "')", null));
                            return  false;
                        }
                    ...
                    if( aThis._v_IdLesi == null) {
                        var aIdLesiResolution = aParmResolutionsDict[ this.PARM_CIE10_CREAR_IDLESI];
                    ...
                    if( aThis._v_IdMorbi == null) {
                        var aIdMorbiResolution = aParmResolutionsDict[ this.PARM_CIE10_CREAR_IDMORBI];
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    if( aThis._v_Titulo) {
                        var aTitulo = aCie10Datos[ "c10Titulo"];
                        if( !aTitulo) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.titulo", null));
                            return false;
                        }

                        if( !( aTitulo == aThis._v_Titulo)) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.titulo == aThis._v_Titulo " + aThis._v_Titulo, null));
                            return false;
                        }
                    }
                    ...
                    if( aThis._v_IdLesi) {
                        var aIdLesi= aCie10Datos[ "idlesi"];
                        if( !aIdLesi) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.idlesi", null));
                            return false;
                        }

                        if( !( aIdLesi == aThis._v_IdLesi)) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.idlesi == aThis._v_IdLesi " + aThis._v_Titulo, null));
                            return false;
                        }
                    }
                    ...
                    if( aThis._v_IdMorbi) {
                        var aIdMorbi= aCie10Datos[ "idmorbi"];
                        if( !aIdMorbi) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.idmorbi", null));
                            return false;
                        }

                        if( !( aIdMorbi == aThis._v_IdMorbi)) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.idmorbi == aThis._v_IdMorbi " + aThis._v_Titulo, null));
                            return false;
                        }
                    }
            ...
            var pS_AuxCie10Crear = function( theCallback) {

                var aMethodName = "pS_AuxCie10Crear";
            ...
            if( pS_AuxCie10Crear){}/* CQT */
            aPrototype.pS_AuxCie10Crear = pS_AuxCie10Crear;
            ...
            var pF_AuxCie10CrearSpringnut = function( theCallback) {
                var aMethodName = "pF_AuxCie10CrearSpringnut";
            ...
            if( pF_AuxCie10CrearSpringnut){}/* CQT */
            aPrototype.pF_AuxCie10CrearSpringnut = pF_AuxCie10CrearSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_AuxCie10CrearSpringnut.bind( this);
            };
            ...
            var pSS_AuxCie10CrearSpringnut = function( theCallback) {
                var aMethodName = "pSS_AuxCie10CrearSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_AuxCie10Crear.bind( this),
            ...
            if( pSS_AuxCie10CrearSpringnut){}/* CQT */
            aPrototype.pSS_AuxCie10CrearSpringnut = pSS_AuxCie10CrearSpringnut;
        ...
        var AuxCie10CrearSpringnutTest_Constructor = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        AuxCie10CrearSpringnutTest_Constructor.prototype = aAuxCie10CrearSpringnutTest_Prototype;





        var AuxCie10CrearSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aAuxCie10CrearSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        AuxCie10CrearSpringnutTest_SuperPrototypeConstructor.prototype = aAuxCie10CrearSpringnutTest_Prototype;



        var aModule = {
            "AuxCie10CrearSpringnutTest_Prototype": aAuxCie10CrearSpringnutTest_Prototype,
            "AuxCie10CrearSpringnutTest_Constructor": AuxCie10CrearSpringnutTest_Constructor,
            "AuxCie10CrearSpringnutTest_SuperPrototypeConstructor": AuxCie10CrearSpringnutTest_SuperPrototypeConstructor
        };
