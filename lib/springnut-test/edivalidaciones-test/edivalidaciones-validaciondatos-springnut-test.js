...
/*
 edivalidaciones-validaciondatos-springnut-test.js
 Creado 201408190827
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-validaciondatos-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.EDIVALIDACIONES_VALIDACIONDATOSLAZY_DEFAULT = false;
            ...
            theToInit.PARMSPREFIX_EDIVALIDACIONES_VALIDACIONDATOS = "edivalidaciones_validaciondatos_springnut";

            theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_URLPATH    = theToInit.PARMSPREFIX_EDIVALIDACIONES_VALIDACIONDATOS + ".URLpath";
            theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_LAZY       = theToInit.PARMSPREFIX_EDIVALIDACIONES_VALIDACIONDATOS + ".lazy";
            theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_IDERROR    = theToInit.PARMSPREFIX_EDIVALIDACIONES_VALIDACIONDATOS + ".iderror";


            theToInit.PARMS_EDIVALIDACIONES_VALIDACIONDATOS = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_IDERROR,
                theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_LAZY,
                theToInit.PARM_EDIVALIDACIONES_VALIDACIONDATOS_IDERROR
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/validacionDatosJSON/";
        ...
        var aEdivalidacionesValidacionDatosSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesValidacionDatosSpringnutTest";
            ...
            aPrototype._v_EdivalidacionesValidacionDatosLazy = null;
            aPrototype._v_EdivalidacionesValidacionDatosRetrieved = null;
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesValidacionDatosSpringnut(
            ...
            var _pInit_EdivalidacionesValidacionDatosSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._v_EdivalidacionesValidacionDatosLazy = null;
                this._v_EdivalidacionesValidacionDatosRetrieved = false;

                this._v_IdError      = null;

                this._v_ValidacionDatos  = null;

                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesValidacionDatosSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesValidacionDatosSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesValidacionDatosSpringnut = _pInit_EdivalidacionesValidacionDatosSpringnut;
            ...
            var pS_CheckLazy = function( theCallback) {
                ...
                if( !( this._v_EdivalidacionesValidacionDatosLazy == null)) {
                ...
                this._v_EdivalidacionesValidacionDatosLazy = this.fResolvedParmValue(  this.PARM_EDIVALIDACIONES_VALIDACIONDATOS_LAZY);
                if( this._v_EdivalidacionesValidacionDatosLazy == null) {
                    this._v_EdivalidacionesValidacionDatosLazy = this.EDIVALIDACIONES_VALIDACIONDATOSLAZY_DEFAULT;
                }
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    if( ( aThis._v_EdivalidacionesValidacionDatosLazy == true) && aThis._v_EdivalidacionesValidacionDatosRetrieved) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EDIVALIDACIONES_VALIDACIONDATOS_URLPATH,
                        aThis.PARM_EDIVALIDACIONES_VALIDACIONDATOS_LAZY,
                        aThis.PARM_EDIVALIDACIONES_VALIDACIONDATOS_IDERROR,
                        aThis.PARM_IDERROR
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_VALIDACIONDATOS_URLPATH];
                    ...
                    if( !aThis._v_IdError) {
                        var aCrIdResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_VALIDACIONDATOS_IDERROR];
                        if( aCrIdResolution && aCrIdResolution._v_Success && aCrIdResolution._v_ParmValue) {
                            aThis._v_IdError = aCrIdResolution._v_ParmValue;
                        }
                        else {
                            var aIdCriterioResolution = aParmResolutionsDict[ aThis.PARM_IDERROR];
                            if( aIdCriterioResolution && aIdCriterioResolution._v_Success && aIdCriterioResolution._v_ParmValue) {
                                aThis._v_IdError = aIdCriterioResolution._v_ParmValue;
                            }
                        }
                        if( !aThis._v_IdError) {
                            theOtherCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_FAIL, null, "!aThis._v_IdError && !aThis._v_Configuration.fParmResolutions( '" + this.PARM_VALIDACION_CAMBIAR_CRID + "')", null));
                            return  false;
                        }
                    }
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    if( !aCriterioDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesValidacionDatos) theResponse.body", null));
                        return false;
                    }
                    ...
                    if( !aTipoCriterioDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesValidacionDatos) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoCriterioDatos == this.TIPO_VALIDACIONDATOS)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesValidacionDatos) ( theResponse.body['vTipo'] == " + this.TIPO_VALIDACIONDATOS + ")", null));
                        return false;
                    }

                    var aSuccessCriterioDatos = aCriterioDatos[ "vSuccess"];
                    if( !aSuccessCriterioDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesValidacionDatos) theResponse.body.vSuccess", null));
                        return false;
                    }


                    aThis._v_ValidacionDatos = aCriterioDatos;

                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, aCriterioDatos, "(EdivalidacionesValidacionDatos) theResponse.body.vCriterios", null);
            ...
            var pS_EdivalidacionesValidacionDatos = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesValidacionDatos";

                this.pReceivedTestCallbackArg( theCallback, aMethodName);


                if( ( this._v_EdivalidacionesValidacionDatosLazy == true) &&
                    !this._v_EdivalidacionesValidacionDatosRetrieved &&
                    !( this._v_ValidacionDatos == null)) {
                    var aRecord = this.fRecord( this._v_Type, this._v_Id, this, aMethodName, this.EVENTKIND_ALREADY, null, null, null);
                    theCallback( null, this.fRecord( this._v_Type, this._v_Id, this, aMethodName, this.EVENTKIND_OK, aRecord, null, null));
                    return;
            ...
            if( pS_EdivalidacionesValidacionDatos){}/* CQT */
            aPrototype.pS_EdivalidacionesValidacionDatos = pS_EdivalidacionesValidacionDatos;
            ...
            var pF_EdivalidacionesValidacionDatosSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesValidacionDatosSpringnut";
            ...
            if( pF_EdivalidacionesValidacionDatosSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesValidacionDatosSpringnut = pF_EdivalidacionesValidacionDatosSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesValidacionDatosSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesValidacionDatosSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesValidacionDatosSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesValidacionDatos.bind( this),
            ...
            if( pSS_EdivalidacionesValidacionDatosSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesValidacionDatosSpringnut = pSS_EdivalidacionesValidacionDatosSpringnut;
        ...
        var EdivalidacionesValidacionDatosSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
            ...
            this._v_EdivalidacionesValidacionDatosLazy = null;
            this._v_EdivalidacionesValidacionDatosRetrieved = null;
        ...
        EdivalidacionesValidacionDatosSpringnutTest_Constructor.prototype = aEdivalidacionesValidacionDatosSpringnutTest_Prototype;





        var EdivalidacionesValidacionDatosSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesValidacionDatosSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesValidacionDatosSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesValidacionDatosSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesValidacionDatosSpringnutTest_Prototype": aEdivalidacionesValidacionDatosSpringnutTest_Prototype,
            "EdivalidacionesValidacionDatosSpringnutTest_Constructor": EdivalidacionesValidacionDatosSpringnutTest_Constructor,
            "EdivalidacionesValidacionDatosSpringnutTest_SuperPrototypeConstructor": EdivalidacionesValidacionDatosSpringnutTest_SuperPrototypeConstructor
        };
