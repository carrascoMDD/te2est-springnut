...
/*
 edivalidaciones-eliminarvalidacion-springnut-test.js
 Creado 201409102326
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-eliminarvalidacion-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARVALIDACION = "edivalidaciones_eliminarvalidacion_springnut";

            theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_URLPATH = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARVALIDACION + ".URLpath";

            theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_EXITOSINOEXISTE = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARVALIDACION + ".exitosinoexiste";

            theToInit.ELIMINARVALIDACION_EXITOSINOEXISTE_DEFAULT = false;


            theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_IDERROR     = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARVALIDACION + ".iderror";


            theToInit.PARMS_EDIVALIDACIONES_ELIMINARVALIDACION = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_EXITOSINOEXISTE,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_IDERROR,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_EXITOSINOEXISTE
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/eliminarValidacionJSON";

            theToInit.EDIVALIDACIONES_ELIMINARVALIDACION_SEVERIDAD_DEFAULT = 0;
        ...
        var aEdivalidacionesEliminarValidacionSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesEliminarValidacionSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesEliminarValidacionSpringnut(
            ...
            var _pInit_EdivalidacionesEliminarValidacionSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesEliminarValidacionSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesEliminarValidacionSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesEliminarValidacionSpringnut = _pInit_EdivalidacionesEliminarValidacionSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_URLPATH,
                        aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_IDERROR,
                        aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_EXITOSINOEXISTE
                    ];
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_URLPATH];
                    ...
                    if( !aThis._v_IdError) {
                        var aIdErrorResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_IDERROR];
                    ...
                    if( aThis._v_ExitoSiNoExiste == null) {
                        var aExitoSiNoExisteResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARVALIDACION_EXITOSINOEXISTE];
                        if( aExitoSiNoExisteResolution && aExitoSiNoExisteResolution._v_Success) {
                            ...
                            aThis._v_ExitoSiNoExiste = aThis.ELIMINARVALIDACION_EXITOSINOEXISTE_DEFAULT;
                        }
                    }
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    var aEliminarValidacion = theResponse.body;
                    if( !aEliminarValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarValidacion) theResponse.body", null));
                        return false;
                    }


                    var aTipoEliminarValidacion = aEliminarValidacion[ "vTipo"];
                    if( !aTipoEliminarValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarValidacion) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoEliminarValidacion == this.TIPO_VALIDACIONDATOS)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarValidacion) ( theResponse.body['vTipo'] == " + this.TIPO_VALIDACIONDATOS + ")", null));
                        return false;
                    }

                    var aSuccessEliminarValidacion = aEliminarValidacion[ "vSuccess"];
                    if( !aSuccessEliminarValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarValidacion) theResponse.body.vSuccess", null));
                        return false;
                    }
                    ...
                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, aValidacionDatos, "(EdivalidacionesEliminarValidacion) theResponse.body.vValidaciones", null);
            ...
            var pS_EdivalidacionesEliminarValidacion = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesEliminarValidacion";
            ...
            if( pS_EdivalidacionesEliminarValidacion){}/* CQT */
            aPrototype.pS_EdivalidacionesEliminarValidacion = pS_EdivalidacionesEliminarValidacion;
            ...
            var pF_EdivalidacionesEliminarValidacionSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesEliminarValidacionSpringnut";
            ...
            if( pF_EdivalidacionesEliminarValidacionSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesEliminarValidacionSpringnut = pF_EdivalidacionesEliminarValidacionSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesEliminarValidacionSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesEliminarValidacionSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesEliminarValidacionSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesEliminarValidacion.bind( this),
            ...
            if( pSS_EdivalidacionesEliminarValidacionSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesEliminarValidacionSpringnut = pSS_EdivalidacionesEliminarValidacionSpringnut;
        ...
        var EdivalidacionesEliminarValidacionSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        EdivalidacionesEliminarValidacionSpringnutTest_Constructor.prototype = aEdivalidacionesEliminarValidacionSpringnutTest_Prototype;





        var EdivalidacionesEliminarValidacionSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesEliminarValidacionSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesEliminarValidacionSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesEliminarValidacionSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesEliminarValidacionSpringnutTest_Prototype": aEdivalidacionesEliminarValidacionSpringnutTest_Prototype,
            "EdivalidacionesEliminarValidacionSpringnutTest_Constructor": EdivalidacionesEliminarValidacionSpringnutTest_Constructor,
            "EdivalidacionesEliminarValidacionSpringnutTest_SuperPrototypeConstructor": EdivalidacionesEliminarValidacionSpringnutTest_SuperPrototypeConstructor
        };
