...
/*
 edivalidaciones-eliminarlistascodigoscondescripcion-springnut-test.js
 Creado 201409102326
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-eliminarlistascodigoscondescripcion-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION = "edivalidaciones_eliminarlistascodigoscondescripcion_springnut";

            theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_URLPATH         = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION + ".URLpath";
            theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_DESCRIPCION     = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION + ".descripcion";
            theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE = theToInit.PARMSPREFIX_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION + ".exitosinoexiste";

            theToInit.ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE_DEFAULT = false;


            theToInit.PARMS_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_DESCRIPCION,
                theToInit.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/eliminarListasCodigosConDescripcionJSON";
        ...
        var aEdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut(
            ...
            var _pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = _pInit_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_URLPATH,
                        aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_DESCRIPCION,
                        aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE
                    ];
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_URLPATH];
                    ...
                    if( !aThis._v_Descripcion) {
                        var aIdCriterioResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_DESCRIPCION];
                        if( aIdCriterioResolution && aIdCriterioResolution._v_Success && aIdCriterioResolution._v_ParmValue) {
                            aThis._v_Descripcion = aIdCriterioResolution._v_ParmValue;
                        }
                    ...
                    if( aThis._v_ExitoSiNoExiste == null) {
                        var aExitoSiNoExisteResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE];
                        if( aExitoSiNoExisteResolution && aExitoSiNoExisteResolution._v_Success) {
                            ...
                            aThis._v_ExitoSiNoExiste = aThis.ELIMINARLISTACODIGOSCONDESCRIPCION_EXITOSINOEXISTE_DEFAULT;
                        }
                    }
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    var aEliminarListasCodigosConDescripcion = theResponse.body;
                    if( !aEliminarListasCodigosConDescripcion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarListasCodigosConDescripcion) theResponse.body", null));
                        return false;
                    }


                    var aTipoEliminarListasCodigosConDescripcion = aEliminarListasCodigosConDescripcion[ "vTipo"];
                    if( !aTipoEliminarListasCodigosConDescripcion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarListasCodigosConDescripcion) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoEliminarListasCodigosConDescripcion == this.TIPO_LISTACODIGOSDATOS)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarListasCodigosConDescripcion) ( theResponse.body['vTipo'] == " + this.TIPO_LISTACODIGOSDATOS + ")", null));
                        return false;
                    }

                    var aSuccessEliminarListasCodigosConDescripcion = aEliminarListasCodigosConDescripcion[ "vSuccess"];
                    if( !aSuccessEliminarListasCodigosConDescripcion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesEliminarListasCodigosConDescripcion) theResponse.body.vSuccess", null));
                        return false;
                    }
                    ...
                    if( this._v_Descripcion) {
                        var aIdListaCodigos = aListaCodigos[ "descripcion"];
                        if( !aIdListaCodigos) {
                        ...
                        if( !( aIdListaCodigos == this._v_Descripcion)) {
                    ...
                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, aListaCodigos, "(EdivalidacionesEliminarListasCodigosConDescripcion) theResponse.body.vValidaciones", null);
            ...
            var pS_EdivalidacionesEliminarListasCodigosConDescripcion = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesEliminarListasCodigosConDescripcion";
            ...
            if( pS_EdivalidacionesEliminarListasCodigosConDescripcion){}/* CQT */
            aPrototype.pS_EdivalidacionesEliminarListasCodigosConDescripcion = pS_EdivalidacionesEliminarListasCodigosConDescripcion;
            ...
            var pF_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut";
            ...
            if( pF_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = pF_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesEliminarListasCodigosConDescripcion.bind( this),
            ...
            if( pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut = pSS_EdivalidacionesEliminarListasCodigosConDescripcionSpringnut;
        ...
        var EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Constructor.prototype = aEdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype;





        var EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype": aEdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Prototype,
            "EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Constructor": EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_Constructor,
            "EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_SuperPrototypeConstructor": EdivalidacionesEliminarListasCodigosConDescripcionSpringnutTest_SuperPrototypeConstructor
        };
