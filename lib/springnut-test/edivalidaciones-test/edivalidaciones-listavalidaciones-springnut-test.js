...
/*
 edivalidaciones-listavalidaciones-springnut-test.js
 Creado 201409102326
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-listavalidaciones-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.EDIVALIDACIONES_LISTAVALIDACIONESLAZY_DEFAULT = false;



            theToInit.PARM_SESSIONTEST       = "sessiontest";

            theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTAVALIDACIONES = "edivalidaciones_listavalidaciones_springnut";

            theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_URLPATH = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTAVALIDACIONES + ".URLpath";
            theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_LAZY    = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTAVALIDACIONES + ".lazy";

            theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_PRIMERO   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTAVALIDACIONES + ".primero";
            theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_CUANTOS   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTAVALIDACIONES + ".cuantos";


            theToInit.PARMS_EDIVALIDACIONES_LISTAVALIDACIONES = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_LAZY,
                theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_PRIMERO,
                theToInit.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_CUANTOS
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/listaValidacionesJSON";


            theToInit.TIPO_LISTAVALIDACIONES = "ListaValidaciones";
        ...
        var aEdivalidacionesListaValidacionesSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesListaValidacionesSpringnutTest";
            ...
            aPrototype._v_EdivalidacionesListaValidacionesLazy = null;
            aPrototype._v_EdivalidacionesListaValidacionesRetrieved = null;
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesListaValidacionesSpringnut(
            ...
            var _pInit_EdivalidacionesListaValidacionesSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._v_EdivalidacionesListaValidacionesLazy = null;
                this._v_EdivalidacionesListaValidacionesRetrieved = false;
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesListaValidacionesSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesListaValidacionesSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesListaValidacionesSpringnut = _pInit_EdivalidacionesListaValidacionesSpringnut;
            ...
            var pS_CheckLazy = function( theCallback) {
                ...
                if( !( this._v_EdivalidacionesListaValidacionesLazy == null)) {
                ...
                this._v_EdivalidacionesListaValidacionesLazy = this.fResolvedParmValue(  this.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_LAZY);
                if( this._v_EdivalidacionesListaValidacionesLazy == null) {
                    this._v_EdivalidacionesListaValidacionesLazy = this.EDIVALIDACIONES_LISTAVALIDACIONESLAZY_DEFAULT;
                }
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    if( ( aThis._v_EdivalidacionesListaValidacionesLazy == true) && aThis._v_EdivalidacionesListaValidacionesRetrieved) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_URLPATH,
                        aThis.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_PRIMERO,
                        aThis.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_CUANTOS
                    ];
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_URLPATH];
                    ...
                    if( this._v_Primero == null) {
                        var aPrimeroResolution = aParmResolutionsDict[ this.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_PRIMERO];
                    ...
                    if( this._v_Cuantos == null) {
                        var aCuantosResolution = aParmResolutionsDict[ this.PARM_EDIVALIDACIONES_LISTAVALIDACIONES_CUANTOS];
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    if( !aListaValidacionesCriterio) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaValidaciones) theResponse.body", null));
                        return false;
                    }
                    ...
                    if( !aTipoListaValidacionesCriterio) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaValidaciones) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoListaValidacionesCriterio == this.TIPO_LISTAVALIDACIONES)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaValidaciones) ( theResponse.body['vTipo'] == " + this.TIPO_LISTAVALIDACIONES + ")", null));
                        return false;
                    }

                    var aSuccessListaValidacionesCriterio = aListaValidacionesCriterio[ "vSuccess"];
                    if( !aSuccessListaValidacionesCriterio) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaValidaciones) theResponse.body.vSuccess", null));
                        return false;
                    }
                    ...
                    if( !someValidaciones) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaValidaciones) theResponse.body.vValidaciones", null));
                        return false;
                    }


                    if( !someValidaciones.length) {
                        aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_INFO, null, "!(EdivalidacionesListaValidaciones) theResponse.body.vValidaciones.length", null);
                    }


                    aThis._v_ValidacionesCriterio = someValidaciones;

                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, someValidaciones.length, "(EdivalidacionesListaValidaciones) theResponse.body.vValidaciones", null);
            ...
            var pS_EdivalidacionesListaValidaciones = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesListaValidaciones";

                this.pReceivedTestCallbackArg( theCallback, aMethodName);


                if( ( this._v_EdivalidacionesListaValidacionesLazy == true) &&
                    !this._v_EdivalidacionesListaValidacionesRetrieved &&
                    !( this._v_ValidacionesCriterio == null)) {
                    var aRecord = this.fRecord( this._v_Type, this._v_Id, this, aMethodName, this.EVENTKIND_ALREADY, null, null, null);
                    theCallback( null, this.fRecord( this._v_Type, this._v_Id, this, aMethodName, this.EVENTKIND_OK, aRecord, null, null));
                    return;
            ...
            if( pS_EdivalidacionesListaValidaciones){}/* CQT */
            aPrototype.pS_EdivalidacionesListaValidaciones = pS_EdivalidacionesListaValidaciones;
            ...
            var pF_EdivalidacionesListaValidacionesSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesListaValidacionesSpringnut";
            ...
            if( pF_EdivalidacionesListaValidacionesSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesListaValidacionesSpringnut = pF_EdivalidacionesListaValidacionesSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesListaValidacionesSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesListaValidacionesSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesListaValidacionesSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesListaValidaciones.bind( this),
            ...
            if( pSS_EdivalidacionesListaValidacionesSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesListaValidacionesSpringnut = pSS_EdivalidacionesListaValidacionesSpringnut;
        ...
        var EdivalidacionesListaValidacionesSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
            ...
            this._v_EdivalidacionesListaValidacionesLazy = null;
            this._v_EdivalidacionesListaValidacionesRetrieved = null;
        ...
        EdivalidacionesListaValidacionesSpringnutTest_Constructor.prototype = aEdivalidacionesListaValidacionesSpringnutTest_Prototype;





        var EdivalidacionesListaValidacionesSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesListaValidacionesSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesListaValidacionesSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesListaValidacionesSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesListaValidacionesSpringnutTest_Prototype": aEdivalidacionesListaValidacionesSpringnutTest_Prototype,
            "EdivalidacionesListaValidacionesSpringnutTest_Constructor": EdivalidacionesListaValidacionesSpringnutTest_Constructor,
            "EdivalidacionesListaValidacionesSpringnutTest_SuperPrototypeConstructor": EdivalidacionesListaValidacionesSpringnutTest_SuperPrototypeConstructor
        };
