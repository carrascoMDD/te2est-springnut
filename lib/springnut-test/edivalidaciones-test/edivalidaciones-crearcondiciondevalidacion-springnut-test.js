...
/*
 edivalidaciones-crearcondiciondevalidacion-springnut-test.js
 Creado 201409102326
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-crearcondiciondevalidacion-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION = "edivalidaciones_crearcondiciondevalidacion_springnut";

            theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_URLPATH = theToInit.PARMSPREFIX_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION + ".URLpath";

            theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDERROR     = theToInit.PARMSPREFIX_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION + ".iderror";
            theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_CONDICION   = theToInit.PARMSPREFIX_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION + ".condicion";
            theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDLISTA      = theToInit.PARMSPREFIX_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION + ".idlista";



            theToInit.PARMS_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_IDERROR,
                theToInit.PARM_IDLISTA,
                theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDERROR,
                theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_CONDICION,
                theToInit.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDLISTA
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/crearCondicionDeValidacionJSON";
        ...
        var aEdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesCrearCondicionDeValidacionSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut(
            ...
            var _pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut = _pInit_EdivalidacionesCrearCondicionDeValidacionSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_IDERROR,
                        aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_URLPATH,
                        aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDERROR,
                        aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_CONDICION,
                        aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDLISTA,
                        aThis.PARM_IDLISTA
                    ];
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_URLPATH];
                    ...
                    if( !aThis._v_IdError) {
                        var aIdErrorResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDERROR];
                        if( aIdErrorResolution && aIdErrorResolution._v_Success && aIdErrorResolution._v_ParmValue) {
                            ...
                            aIdErrorResolution = aParmResolutionsDict[ aThis.PARM_IDERROR];
                            if( aIdErrorResolution && aIdErrorResolution._v_Success && aIdErrorResolution._v_ParmValue) {
                                aThis._v_IdError = aIdErrorResolution._v_ParmValue;
                            }
                        }
                    ...
                    if( !aThis._v_Condicion) {
                        var aCondicionResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_CONDICION];
                    ...
                    if( aThis._v_IdLista == null) {
                        var aIdListaResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_CREARCONDICIONDEVALIDACION_IDLISTA];
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    var aCrearCondicionDeValidacion = theResponse.body;
                    if( !aCrearCondicionDeValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesCrearCondicionDeValidacion) theResponse.body", null));
                        return false;
                    }


                    var aTipoCrearCondicionDeValidacion = aCrearCondicionDeValidacion[ "vTipo"];
                    if( !aTipoCrearCondicionDeValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesCrearCondicionDeValidacion) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoCrearCondicionDeValidacion == this.TIPO_CONDICIONVALIDACION)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesCrearCondicionDeValidacion) ( theResponse.body['vTipo'] == " + this.TIPO_CONDICIONVALIDACION + ")", null));
                        return false;
                    }

                    var aSuccessCrearCondicionDeValidacion = aCrearCondicionDeValidacion[ "vSuccess"];
                    if( !aSuccessCrearCondicionDeValidacion) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesCrearCondicionDeValidacion) theResponse.body.vSuccess", null));
                        return false;
                    }


                    var aCondicionValidacion = theResponse.body;


                    if( aThis._v_IdError) {
                        var aIdError = aCondicionValidacion[ "iderror"];
                        if( !aIdError) {
                        ...
                        if( !( aIdError == aThis._v_IdError)) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.iderror == aThis._v_IdError " + aThis._v_IdError, null));
                            return false;
                        }
                    }
                    ...
                    if( aThis._v_Condicion) {
                        var aCondicion = aCondicionValidacion[ "condicion"];
                        if( !aCondicion) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.condicion", null));
                            return false;
                        }

                        if( !( aCondicion.toUpperCase() == aThis._v_Condicion.toUpperCase())) {
                            theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "! theResponse.body.condicion == aThis._v_Condicion " + aThis._v_Condicion, null));
                            return false;
                        }
                    }
                    ...
                    if( !( aThis._v_IdLista == null) && !( aThis._v_IdLista == aThis.IDLISTA_DEFAULT)) {
                        var aIdLista = aCondicionValidacion[ "idlista"];
                        if( ( typeof aIdLista == "undefined") || ( aIdLista == null)) {
                    ...
                    aThis._v_CondicionDeValidacion = aCondicionValidacion;

                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, aCondicionValidacion, "(CondicionDeValidacion) theResponse.body._v_CondicionDeValidacion", null);
            ...
            var pS_EdivalidacionesCrearCondicionDeValidacion = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesCrearCondicionDeValidacion";
            ...
            if( pS_EdivalidacionesCrearCondicionDeValidacion){}/* CQT */
            aPrototype.pS_EdivalidacionesCrearCondicionDeValidacion = pS_EdivalidacionesCrearCondicionDeValidacion;
            ...
            var pF_EdivalidacionesCrearCondicionDeValidacionSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesCrearCondicionDeValidacionSpringnut";
            ...
            if( pF_EdivalidacionesCrearCondicionDeValidacionSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesCrearCondicionDeValidacionSpringnut = pF_EdivalidacionesCrearCondicionDeValidacionSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesCrearCondicionDeValidacion.bind( this),
            ...
            if( pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut = pSS_EdivalidacionesCrearCondicionDeValidacionSpringnut;
        ...
        var EdivalidacionesCrearCondicionDeValidacionSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        EdivalidacionesCrearCondicionDeValidacionSpringnutTest_Constructor.prototype = aEdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype;





        var EdivalidacionesCrearCondicionDeValidacionSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesCrearCondicionDeValidacionSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype": aEdivalidacionesCrearCondicionDeValidacionSpringnutTest_Prototype,
            "EdivalidacionesCrearCondicionDeValidacionSpringnutTest_Constructor": EdivalidacionesCrearCondicionDeValidacionSpringnutTest_Constructor,
            "EdivalidacionesCrearCondicionDeValidacionSpringnutTest_SuperPrototypeConstructor": EdivalidacionesCrearCondicionDeValidacionSpringnutTest_SuperPrototypeConstructor
        };
