...
/*
 edivalidaciones-listacodigosdatos-springnut-test.js
 Creado 201409151712
 */
...
(function () {
    ...
    var aMod_definer = function( theM_runsubs_test, theM_parms_general) {
        ...
        var ModuleName     = "edivalidaciones-listacodigosdatos-springnut-test";
        ...
        var pgInitWithModuleConstants = function( theToInit) {
            ...
            theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTACODIGOSDATOS = "edivalidaciones_listacodigosdatos_springnut";

            theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_URLPATH   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTACODIGOSDATOS + ".URLpath";
            theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_IDLISTA   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTACODIGOSDATOS + ".idlista";

            theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_PRIMERO   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTACODIGOSDATOS + ".primero";
            theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_CUANTOS   = theToInit.PARMSPREFIX_EDIVALIDACIONES_LISTACODIGOSDATOS + ".cuantos";

            theToInit.PARMS_EDIVALIDACIONES_LISTACODIGOSDATOS = [
                theToInit.PARM_SESSIONTEST,
                theToInit.PARM_IDLISTA,
                theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_URLPATH,
                theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_IDLISTA,
                theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_PRIMERO,
                theToInit.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_CUANTOS
            ];



            theToInit.URLPATH_DEFAULT = "/edicionValidaciones/listaCodigosDatosJSON/";
        ...
        var aEdivalidacionesListaCodigosDatosSpringnutTest_Prototype = (function() {
            ...
            aPrototype._v_Type = "EdivalidacionesListaCodigosDatosSpringnutTest";
            ...
            var _pInit = function( theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                this._pInit_EdivalidacionesListaCodigosDatosSpringnut(
            ...
            var _pInit_EdivalidacionesListaCodigosDatosSpringnut = function(
                theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
                ...
                if( this.RECORDINITS) { this.fRecord( this._v_Type, this._v_Id, this, "_pInit_EdivalidacionesListaCodigosDatosSpringnut", this.EVENTKIND_INIT, null, null, null);}
            };
            if( _pInit_EdivalidacionesListaCodigosDatosSpringnut){}/* CQT */
            aPrototype._pInit_EdivalidacionesListaCodigosDatosSpringnut = _pInit_EdivalidacionesListaCodigosDatosSpringnut;
            ...
            var fLazyInitializer = function( theCallback, theMethodName) {
                ...
                var aLazyInitializerFunction = (function( theOtherCallback) {
                    ...
                    var someParmsToResolve = [
                        ...
                        aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_URLPATH,
                        aThis.PARM_IDLISTA,
                        aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_IDLISTA,
                        aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_PRIMERO,
                        aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_CUANTOS
                    ];
                    ...
                    var aURLpathResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_URLPATH];
                    ...
                    if( !aThis._v_IdListaCodigos) {
                        var aIdCriterioResolution = aParmResolutionsDict[ aThis.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_IDLISTA];
                    ...
                    if( this._v_Primero == null) {
                        var aPrimeroResolution = aParmResolutionsDict[ this.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_PRIMERO];
                    ...
                    if( this._v_Cuantos == null) {
                        var aCuantosResolution = aParmResolutionsDict[ this.PARM_EDIVALIDACIONES_LISTACODIGOSDATOS_CUANTOS];
            ...
            var fURLpath = function( theCallback) {
                ...
                var aFunction = (function( theOtherCallback) {
                    ...
                    var aURL = aThis._v_BaseURL + aURLpath + aThis._v_IdListaCodigos;
            ...
            var fResultParser = function( theCallback, theMethodName) {
                ...
                var aResultParserFunction = (function( theCallback, theError, theResponse, theBody) {
                    ...
                    var aListaCodigosDatos = theResponse.body;
                    if( !aListaCodigosDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaCodigosDatos) theResponse.body", null));
                        return false;
                    }


                    var aTipoListaCodigosDatos = aListaCodigosDatos[ "vTipo"];
                    if( !aTipoListaCodigosDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaCodigosDatos) theResponse.body['vTipo']", null));
                        return false;
                    }


                    if( !( aTipoListaCodigosDatos == this.TIPO_LISTACODIGOSDATOS)) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaCodigosDatos) ( theResponse.body['vTipo'] == " + this.TIPO_LISTACODIGOSDATOS + ")", null));
                        return false;
                    }

                    var aSuccessListaCodigosDatos = aListaCodigosDatos[ "vSuccess"];
                    if( !aSuccessListaCodigosDatos) {
                        theCallback( aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_STEP_FAIL, null, "!(EdivalidacionesListaCodigosDatos) theResponse.body.vSuccess", null));
                        return false;
                    }
                    ...
                    aThis.fRecord( aThis._v_Type, aThis._v_Id, aThis, theMethodName, aThis.EVENTKIND_RETRIEVEDDATA, aListaCodigos, "(EdivalidacionesListaCodigosDatos) theResponse.body", null);
            ...
            var pS_EdivalidacionesListaCodigosDatos = function( theCallback) {

                var aMethodName = "pS_EdivalidacionesListaCodigosDatos";
            ...
            if( pS_EdivalidacionesListaCodigosDatos){}/* CQT */
            aPrototype.pS_EdivalidacionesListaCodigosDatos = pS_EdivalidacionesListaCodigosDatos;
            ...
            var pF_EdivalidacionesListaCodigosDatosSpringnut = function( theCallback) {
                var aMethodName = "pF_EdivalidacionesListaCodigosDatosSpringnut";
            ...
            if( pF_EdivalidacionesListaCodigosDatosSpringnut){}/* CQT */
            aPrototype.pF_EdivalidacionesListaCodigosDatosSpringnut = pF_EdivalidacionesListaCodigosDatosSpringnut;
            ...
            var fOwnTestMethodToRun = function() {
                return this.pSS_EdivalidacionesListaCodigosDatosSpringnut.bind( this);
            };
            ...
            var pSS_EdivalidacionesListaCodigosDatosSpringnut = function( theCallback) {
                var aMethodName = "pSS_EdivalidacionesListaCodigosDatosSpringnut";
                ...
                this._v_StepsToRun = [
                    ...
                    this.pS_EdivalidacionesListaCodigosDatos.bind( this),
            ...
            if( pSS_EdivalidacionesListaCodigosDatosSpringnut){}/* CQT */
            aPrototype.pSS_EdivalidacionesListaCodigosDatosSpringnut = pSS_EdivalidacionesListaCodigosDatosSpringnut;
        ...
        var EdivalidacionesListaCodigosDatosSpringnutTest_Constructor = function(
            theTitle, theConfiguration, theIdentifier, theRecorder, theSession) {
        ...
        EdivalidacionesListaCodigosDatosSpringnutTest_Constructor.prototype = aEdivalidacionesListaCodigosDatosSpringnutTest_Prototype;





        var EdivalidacionesListaCodigosDatosSpringnutTest_SuperPrototypeConstructor = function( ) {

            /* Keep handy reference to super-prototype for super method invocation */
            this._v_SuperPrototype = theM_runsubs_test.RunSubsTest_Prototype;

            this._v_Prototype = aEdivalidacionesListaCodigosDatosSpringnutTest_Prototype;
            this._v_Type = null;
        ...
        EdivalidacionesListaCodigosDatosSpringnutTest_SuperPrototypeConstructor.prototype = aEdivalidacionesListaCodigosDatosSpringnutTest_Prototype;



        var aModule = {
            "EdivalidacionesListaCodigosDatosSpringnutTest_Prototype": aEdivalidacionesListaCodigosDatosSpringnutTest_Prototype,
            "EdivalidacionesListaCodigosDatosSpringnutTest_Constructor": EdivalidacionesListaCodigosDatosSpringnutTest_Constructor,
            "EdivalidacionesListaCodigosDatosSpringnutTest_SuperPrototypeConstructor": EdivalidacionesListaCodigosDatosSpringnutTest_SuperPrototypeConstructor
        };
