...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-06-adminoperadores launch-01-noautorizado-springnut samplelaunchone-10-adminoperadores-noautorizado-operador-crear.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
