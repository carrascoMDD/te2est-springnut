...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-06-adminoperadores samplelaunchone-81-adminoperadores-operador-cambiar-ultidentifica-ine.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
