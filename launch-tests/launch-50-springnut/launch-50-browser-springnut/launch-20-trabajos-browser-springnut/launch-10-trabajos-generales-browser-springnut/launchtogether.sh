...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-20-trabajos-browser-springnut launch-10-trabajos-generales-browser-springnut launchtogether.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
