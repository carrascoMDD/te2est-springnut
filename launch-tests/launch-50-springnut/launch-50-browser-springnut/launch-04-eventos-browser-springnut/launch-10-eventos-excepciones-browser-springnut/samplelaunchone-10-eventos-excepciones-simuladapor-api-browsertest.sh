...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-04-eventos-browser-springnut launch-10-eventos-excepciones-browser-springnut samplelaunchone-10-eventos-excepciones-simuladapor-api-browsertest.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
