...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-04-eventos-browser-springnut launch-42-eventos-cambios-browser-springnut samplelaunchone-10-cambios-auxauditables-browsertest.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
