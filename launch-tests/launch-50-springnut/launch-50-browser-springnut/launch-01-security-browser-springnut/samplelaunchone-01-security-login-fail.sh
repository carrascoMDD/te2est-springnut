...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-01-security-browser-springnut samplelaunchone-01-security-login-fail-browsertest.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
