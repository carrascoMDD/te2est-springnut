...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-01-security-browser-springnut samplelaunchone-13-security-autorizado-administrador-bymethodannotation-fail-browsertest.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
