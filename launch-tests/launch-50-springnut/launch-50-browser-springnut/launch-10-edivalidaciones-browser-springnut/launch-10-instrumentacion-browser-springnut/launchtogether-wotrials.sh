...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-10-edivalidaciones-browser-springnut launch-10-edivalidaciones-instrumentacion-browser-springnut launchtogether-wotrials.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
