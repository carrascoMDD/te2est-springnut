...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-50-browser-springnut launch-02-perfilespaginas-browser-springnut samplelaunchone-01-perfilespaginas-sinperfiles-fail.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
