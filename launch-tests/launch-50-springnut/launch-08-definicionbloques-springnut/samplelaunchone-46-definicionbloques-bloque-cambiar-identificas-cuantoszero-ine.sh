...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-08-definicionbloques-springnut samplelaunchone-46-definicionbloques-bloque-cambiar-identificas-cuantoszero-ine.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
