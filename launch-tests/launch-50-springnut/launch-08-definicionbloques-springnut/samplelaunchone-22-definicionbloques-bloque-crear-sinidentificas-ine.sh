...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-08-definicionbloques-springnut samplelaunchone-22-definicionbloques-bloque-crear-ine-sinidentificas.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
