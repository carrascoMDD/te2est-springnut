...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-07-ficheros-springnut samplelaunchone-10-ficheros-ine-lista.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
