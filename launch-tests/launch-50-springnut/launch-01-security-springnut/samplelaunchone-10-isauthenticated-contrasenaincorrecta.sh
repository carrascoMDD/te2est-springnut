...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-01-security-springnut samplelaunchone-10-isauthenticated-contrasenaincorrecta.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
