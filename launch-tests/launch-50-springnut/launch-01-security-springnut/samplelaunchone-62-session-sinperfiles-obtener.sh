...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-01-security-springnut samplelaunchone-62-session-sinperfiles-obtener.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
