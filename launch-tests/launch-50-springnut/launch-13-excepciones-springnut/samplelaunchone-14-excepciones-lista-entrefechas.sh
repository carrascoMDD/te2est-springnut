...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-13-excepciones-springnut samplelaunchone-14-excepciones-lista-entrefechas.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
