...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-14-accesos-springnut samplelaunchone-10-accesosoperadores-lista-recientes.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
