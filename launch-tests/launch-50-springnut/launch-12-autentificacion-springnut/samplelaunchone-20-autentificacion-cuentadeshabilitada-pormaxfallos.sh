...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-12-autentificacion-springnut samplelaunchone-20-autentificacion-cuentadeshabilitada-pormaxfallos.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
