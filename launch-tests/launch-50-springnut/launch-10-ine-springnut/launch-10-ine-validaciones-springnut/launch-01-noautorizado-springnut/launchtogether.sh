...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-10-ine-springnut launch-10-ine-validaciones-springnut launch-01-noautorizado launchtogether.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
