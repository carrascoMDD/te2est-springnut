...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-05-edivalidaciones-springnut launch-01-noautorizado-springnut launchtogether.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
