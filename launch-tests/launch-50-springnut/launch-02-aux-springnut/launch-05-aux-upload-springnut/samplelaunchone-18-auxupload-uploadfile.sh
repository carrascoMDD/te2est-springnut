...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-05-aux-upload-springnut samplelaunchone-18-auxupload-uploadfile.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
