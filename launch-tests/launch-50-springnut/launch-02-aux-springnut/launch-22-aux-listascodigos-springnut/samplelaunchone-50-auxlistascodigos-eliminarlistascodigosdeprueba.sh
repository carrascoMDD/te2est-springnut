...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-22-aux-listascodigos-springnut samplelaunchone-50-auxlistascodigos-eliminarlistascodigosdeprueba.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
