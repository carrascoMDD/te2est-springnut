...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-74-aux-fechahora-springnut samplelaunchone-02-auxfechahora-deltabefore-millis.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
