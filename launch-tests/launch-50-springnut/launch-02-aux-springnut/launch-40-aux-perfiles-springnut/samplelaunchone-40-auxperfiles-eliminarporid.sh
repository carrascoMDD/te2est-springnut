...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-40-aux-perfiles-springnut samplelaunchone-40-auxperfiles-eliminarporid.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
