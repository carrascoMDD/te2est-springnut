...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-40-aux-perfiles-springnut samplelaunchone-10-auxperfiles-eliminarsiexiste.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
