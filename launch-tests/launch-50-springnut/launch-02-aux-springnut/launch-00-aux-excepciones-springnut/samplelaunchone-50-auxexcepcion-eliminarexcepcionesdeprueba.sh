...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-00-aux-excepciones-springnut samplelaunchone-50-auxexcepcion-eliminarexcepcionesdeprueba.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
