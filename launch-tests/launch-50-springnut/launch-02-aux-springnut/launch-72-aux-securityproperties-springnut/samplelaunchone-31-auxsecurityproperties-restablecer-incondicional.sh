...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-72-aux-securityproperties-springnut samplelaunchone-31-auxasecurityproperties-restablecer-incondicional.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
