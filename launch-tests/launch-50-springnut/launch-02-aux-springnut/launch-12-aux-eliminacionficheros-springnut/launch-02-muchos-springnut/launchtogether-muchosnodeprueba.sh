...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut  launch-12-eliminacionficheros-springnut launch-02-muchos-springnut launchtogether-muchosnodeprueba.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
