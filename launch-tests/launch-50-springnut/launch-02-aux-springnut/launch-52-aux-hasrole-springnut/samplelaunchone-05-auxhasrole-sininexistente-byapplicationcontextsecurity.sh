...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-02-aux-springnut launch-52-aux-hasrole-springnut samplelaunchone-05-auxhasrole-sininexistente-byapplicationcontextsecurity-springnut-test.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
