...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-10-aux-springnut launch-10-aux-boletinesascii-springnut samplelaunchone-10-boletinesascii-blanco-objeto.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
