...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-50-springnut launch-18-vercambios-springnut samplelaunchone-10-vercambios-lista-recientes.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
