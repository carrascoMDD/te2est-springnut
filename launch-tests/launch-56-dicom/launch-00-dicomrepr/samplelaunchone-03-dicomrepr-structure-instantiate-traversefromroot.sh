...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-56-dicom launch-00-dicomrepr samplelaunchone-03-dicomrepr-structure-instantiate-traversefromroot.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
