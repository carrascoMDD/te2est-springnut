...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-52-istdicom launch-01-query-istdicom launch-02-query-php-istdicom samplelaunchone-20-query-php-study-list-iterateinstances-dicomcached-nocachehit-istdicom.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
