...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-52-istdicom launch-01-query-istdicom launch-01-query-solr-istdicom samplelaunchone-01-query-solr-study-list-istdicom.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
