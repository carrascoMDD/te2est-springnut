...
echo -e ',{"exit":'$aColorEscape$aRetCode'\033[0m, "file":"'$aColorEscape'launch-54-orthanc launch-01-orthanc-rest samplelaunchone-70-orthanc-rest-instances-tags-iterate.sh\033[0m"},'
if [ $1 ]
then
    return $aRetCode
else
