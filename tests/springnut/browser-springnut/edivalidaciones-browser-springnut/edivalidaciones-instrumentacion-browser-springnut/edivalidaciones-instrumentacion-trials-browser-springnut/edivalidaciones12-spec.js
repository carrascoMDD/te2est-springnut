...
module.exports = (function() {
    ...
    describe( aTitle, function() {
        ...
        var aSubtitle = 'master tabs, seleccion y edicion';
            ...
            for( var aMasterGridNameIdx=0; aMasterGridNameIdx < aNumMasterGridNames; aMasterGridNameIdx++) {
                ...
                if( aMasterGridName) {
                    ...
                    aLastPromise = (function() {
                        var aLastPromise_here = aLastPromise;
                        var aMasterGridName_here = aMasterGridName;
                        return aLastPromise_here
                            .then( function() {
                            ...
                            .then( function() {
                                ...
                                var anEditorName = MASTERGRID_EDITORS[ aMasterGridName_here];

                                expect( element( by.id( "didSpringnut_Edivalidaciones_Editor_" + anEditorName + "_Button_Open")).isPresent()).toBe( true);

                                expect( element( by.id( "didSpringnut_Edivalidaciones_Editor_" + anEditorName + "_Button_Open")).isDisplayed()).toBe( true);

                                element( by.id( "didSpringnut_Edivalidaciones_Editor_" + anEditorName + "_Button_Open")).click();
