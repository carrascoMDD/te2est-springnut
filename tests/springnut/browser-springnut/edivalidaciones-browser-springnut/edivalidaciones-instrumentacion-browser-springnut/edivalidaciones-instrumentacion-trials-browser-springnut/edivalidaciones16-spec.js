...
module.exports = (function() {
    ...
    describe( aTitle, function() {
        ...
        var GRID_EDITORS= {};
        GRID_EDITORS[ CONDICIONES_NAME]            = CONDICION_NAME;
        GRID_EDITORS[ VALIDACIONESDECRITERIO_NAME] = VALIDACIONDECRITERIO_NAME;
        GRID_EDITORS[ CODIGOSDELISTA_NAME]         = CODIGODELISTA_NAME;


        var GRID_SUBGRIDS= {};
        GRID_SUBGRIDS[ VALIDACIONES_NAME]       = CONDICIONES_NAME;
        GRID_SUBGRIDS[ CRITERIOS_NAME]          = VALIDACIONESDECRITERIO_NAME;
        GRID_SUBGRIDS[ LISTASCODIGOS_NAME]      = CODIGOSDELISTA_NAME;



        var SELECTIONSBYCONTENT = {};
        SELECTIONSBYCONTENT[ VALIDACIONES_NAME]           = { "columnIndex": 2, "spanIndex":  0, "value":  "A17"};
        SELECTIONSBYCONTENT[ CONDICIONES_NAME]            = { "columnIndex":  2, "spanIndex":  0, "value":  "*edad>65 AND causabasica IN LISTA"};
        ...
        SELECTIONSBYCONTENT[ LISTASCODIGOS_NAME]          = { "columnIndex": 1, "spanIndex":  0, "value":  "*Causa rara en menores 75 años"};
        SELECTIONSBYCONTENT[ CODIGOSDELISTA_NAME]         = { "columnIndex":  0, "spanIndex":  0, "valueIndex":  0};
        ...
        EDITORS_FIELDCHANGES[ CONDICION_NAME] = [
            {
                "fieldName": "condicion",
                "type":      "Text",
                "value":     "edad>65 AND causabasica IN LISTA protractorspec16 $timestamp"
            }
        ];

        EDITORS_FIELDCHANGES[ VALIDACIONDECRITERIO_NAME] = [
            {
                "fieldName": "descripcion",
                "type":      "Text",
                "value":     "Causa de muerte rara en mayores de 65 años de criterio protractorspec16 $timestamp"
            },
            {
                "fieldName": "severidad",
                "type":      "IntYesNo",
        ...
        EDITORS_FIELDCHANGES[ CODIGODELISTA_NAME] = [
            {
                "fieldName": "idcie10",
                "type":      "String",
                "value":     "$millis"
        ...
        var pPtrDo_SubTab = function( theTabName, theFullTitles) {


            var aSubGridName = GRID_SUBGRIDS[ theTabName];
            if( !aSubGridName) {
            ...
            var aSubgridRowSelectedPromise = pPtrDo_SelectTab( theTabName)
                .then( function() {
            ...
            var anEditorName = GRID_EDITORS[ aSubGridName];
            if( !anEditorName) {
                return  aSubgridRowSelectedPromise
                    .then( function() {
            ...
            var anEditedPromise = aSubgridRowSelectedPromise
                .then( function() {
                    return pPtrDo_EditorOpen( anEditorName)
                })
                .then( function() {
            ...
            var aSubSubGridName = GRID_SUBGRIDS[ aSubGridName];
            if( !aSubSubGridName) {
                return anEditedPromise;
            }
            ...
            return anEditedPromise
                .then( function() {
                    ...
                    someSubTitles.push( aSubSubGridName);

                    return fDoPtr_RunningTest( someSubTitles, aSubSubGridName)
                        .then( function() {

                            return pPtrDo_SubTab( aSubGridName, someSubTitles);
                        });
                });
        ...
        var aSubtitle2 = 'master grids y grids subordinadas';
                    ...
                    var aDoTabFunction = (function() {
                        ...
                        return function() {
                            return fDoPtr_RunningTest( [ aTitle, aSubtitle2], aMasterGridName_here)
                                .then( function() {
                                    return pPtrDo_SubTab( aMasterGridName_here, [ aTitle, aSubtitle2]);
                                });
                        }
                    })();
