...
module.exports = (function() {
    ...
    describe( aTitle, function() {
        ...
        var CIE10DELISTA_NAME            = "Cie10DeListaCodigosDeCondicion";
        ...
        var GRID_EDITORS= {};
        GRID_EDITORS[ VALIDACIONES_NAME]           = VALIDACION_NAME;
        GRID_EDITORS[ CONDICIONES_NAME]            = CONDICION_NAME;
        GRID_EDITORS[ CODIGOSDECONDICION_NAME]     = CIE10DELISTA_NAME;
        GRID_EDITORS[ CRITERIOS_NAME]              = CRITERIO_NAME;
        GRID_EDITORS[ VALIDACIONESDECRITERIO_NAME] = VALIDACIONDECRITERIO_NAME;
        GRID_EDITORS[ LISTASCODIGOS_NAME]          = LISTACODIGOS_NAME;
        GRID_EDITORS[ SIMBOLOSPERMITIDOS_NAME]     = SIMBOLOPERMITIDO_NAME;


        var GRID_SUBGRIDS= {};
        GRID_SUBGRIDS[ VALIDACIONES_NAME]       = [ CONDICIONES_NAME];
        GRID_SUBGRIDS[ CONDICIONES_NAME]        = [ CODIGOSDECONDICION_NAME];
        ...
        MASTERGRIDS_SELECTIONSBYCONTENT[ CONDICIONES_NAME]            = { "columnIndex":  2, "spanIndex":  0, "value":  "*edad>65 AND causabasica IN LISTA"};
        MASTERGRIDS_SELECTIONSBYCONTENT[ CODIGOSDECONDICION_NAME]     = { "columnIndex":  2, "spanIndex":  0, "value":  "B200"};
        MASTERGRIDS_SELECTIONSBYCONTENT[ CRITERIOS_NAME]              = { "columnIndex": 1, "spanIndex":  0, "value":  "*Demográfica Grave"};
        MASTERGRIDS_SELECTIONSBYCONTENT[ VALIDACIONESDECRITERIO_NAME] = { "columnIndex": 2, "spanIndex":  0, "value":  "DG02a"};
        MASTERGRIDS_SELECTIONSBYCONTENT[ LISTASCODIGOS_NAME]          = { "columnIndex": 1, "spanIndex":  0, "value":  "*Causa rara en menores 75 años"};
        MASTERGRIDS_SELECTIONSBYCONTENT[ CODIGOSDELISTA_NAME]         = { "columnIndex":  0, "spanIndex":  0, "value":  "*M800"};
        ...
        EDITORS_FIELDCHANGES[ VALIDACION_NAME] = [
            {
                ...
                "type":      "Text",
                "value":     "Causa de muerte rara en mayores de 65 años protractorspec15 $timestamp"
            },
            {
                "fieldName": "severidad",
                "type":      "IntYesNo",
        ...
        EDITORS_FIELDCHANGES[ CRITERIO_NAME] = [
            {
                "fieldName": "crNombre",
                "type":      "String",
                "value":     "Demográfica Grave protractorspec15 $timestamp"
            },
            {
                "fieldName": "crDescripcion",
                "type":      "Text",
                "value":     "descripcion Demográfica Grave protractorspec15 $timestamp"
            }
        ];
        ...
        EDITORS_FIELDCHANGES[ LISTACODIGOS_NAME] = [
            {
                "fieldName": "descripcion",
                "type":      "Text",
                "value":     "Causa rara en menores 75 años protractorspec15 $timestamp"
            }
        ];
        ...
        var pPtrDo_UnpinTab = function( theTabName) {
            ...
            expect( aPtrEl_UnpinnedTabImg.isDisplayed()).toBe( true);
        ...
        var pPtrDo_TopTab = function( theTabName) {
            ...
            var anEditorName = GRID_EDITORS[ theTabName];
        ...
        var aSubtitle2 = 'master tabs: select tab, select grid row, open editor, change fields, save';
